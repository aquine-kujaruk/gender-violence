...
import rec1 from '../assets/rec-1.jpg';
import rec2 from '../assets/rec-2.jpg';
import rec3 from '../assets/rec-3.jpg';
import rec4 from '../assets/rec-4.jpg';
import rec5 from '../assets/rec-5.jpg';
...
const useStyle = makeStyles((theme) => ({
	...
	textContainer: {
		height: `calc(100vh - ${theme.mixins.toolbar.minHeight + 8 + 30 + 48 + 80}px - 20vh)`
	},
	text: {
		fontWeight: 400
	},
...
const Action5DInfo = () => {
	...
	const images = [rec1, rec2, rec3, rec4, rec5];
						...
						<Grid container>
							...
							<Grid item xs={12}>
								<Box
									width={1}
									height="20vh"
									style={{background: `url(${images[index]}) 0% 0% / cover no-repeat`}}
								/>
							</Grid>
						</Grid>
					</Grid>
